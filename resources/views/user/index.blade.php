...
<div class="container">
    <div class="row" id="app">
        ...
        <div class="col-10">
            ...
            <div class="tab-pane fade" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list"><houses :your_houses="{{$yourHouses->toJson()}}" route_home="{{route('home')}}"></houses></div>
